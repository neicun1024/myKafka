...
![20220402134213](https://raw.githubusercontent.com/neicun1024/PicBed/main/images_for_markdown/20220402134213.png)
![20220402135534](https://raw.githubusercontent.com/neicun1024/PicBed/main/images_for_markdown/20220402135534.png)
第一轮投票：
1. 生成一张自己的选票（此时Node-1中有选票（1，0））
2. 把选票投给对方（此时Node-1中有选票（1，0）和（2，0））
3. 把zxid/myid更大的选票投到投票箱中（Node-1投的就是（2，0））

第二轮投票：
1. 将手上较大的选票投出去（上一轮较大的选票，对于Node-1来说就是（2，0））
2. 把选票投给对方（此时Node-1中的选票都是（2，0））
3. 把zxid/myid更大的选票投到投票箱中（Node-1投的就是（2，0））
此时投票箱中有票数超过集群半数的服务器节点，该节点确定为Leader，选举结束